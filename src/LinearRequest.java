...
public class LinearRequest implements Comparable<LinearRequest>{
  ...
  //TO DO: make variable/list for driver assigned to this request
  public ArrayList<Driver> driverList = new ArrayList<Driver>();
  public ArrayList<Boolean> servable = new ArrayList<Boolean>();
	...
	public LinearRequest copy(){
		LinearRequest c = new LinearRequest(this.startPos, this.finishPos, this.pickTime);
		return c;
	}
	
	public String toString() {
		return "StartPos: " + startPos + ", finishPos: " + finishPos + ", (" + pickTime/6 + ":" + pickTime%6*10 + "," + finishTime/6 + ":" + finishTime%6*10 + "); " + "f-value: " + f_value;

    //"StartPos: " + startPos/6 + "h," + startPos%6*10 +  "m " + "finishPos: " + finishPos/6 + "h," + finishPos%6*10 + "m" + ", (" + pickTime/6 + ":" + pickTime%6*10 + "," + finishTime/6 + ":" + finishTime%6*10 + "); " + "f-value: " + f_value + " Driver Name: " + driverList.get(0).getName() + " Driver origin: " + driverList.get(0).getOrigin() + " Driver id: " + driverList.get(0);
	}
